...
/**
 * Servlet implementation class ServeletGetBanKuai
 */
@WebServlet("/ServeletGetBanKuai")
public class ServeletGetBanKuai extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServeletGetBanKuai() {
        super();
